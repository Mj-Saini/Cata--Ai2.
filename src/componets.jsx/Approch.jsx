              ...
              <div className="cards_blue2 d-flex flex-column justify-content-between">
                  ...
                  >
                    <div className="col-xl-6 ">
                      <div className="py-4 px-3">
                        <img className="w-100 pe-3" src={graph1} alt="img" />
                      </div>
                    </div>
                    <div className="col-xl-6">
                ...
                {activeTab === "Event-Driven" && (
                  ...
                  >
                    <div className="col-xl-6 ">
                      <div className="py-4 px-3">
                        <img className="w-100 pe-3" src={graph} alt="img" />
                      </div>
                    </div>
                    <div className="col-xl-6">
                      <div className=" ps-xl-5">
                ...
                {activeTab === "Artificial Intelligence" && (
                  ...
                  >
                    <div className="col-xl-6 ">
                      <div className="py-4 px-3">
                        <img className="w-100 pe-3" src={intelli} alt="img" />
                      </div>
                    </div>
                    <div className="col-xl-6">
                      <div className=" ps-xl-5">
                ...
                {activeTab === "Predictive Analytics" && (
                  ...
                  >
                    <div className="col-xl-6 ">
                      <div className="py-4 px-3">
                        <img className="w-100 pe-3" src={anylise} alt="img" />
                      </div>
                    </div>
                    <div className="col-xl-6">
                      <div className=" ps-xl-5">
